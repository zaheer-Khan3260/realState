...
export default function ChoosUs() {
    ...
    return (
       <div className="w-full m-auto h-auto mt-12 text-center">
        <div>
        ...
        <div className="flex flex-wrap ml- w-full m-auto mt-4 xl:mt-14">
            <div className="">
                <img src={choosUsImage}
                 alt="chossusImage"
                 className=" h-[15rem] md:w-[40rem] md:h-[25rem] lg:w-[20rem] lg:h-[25rem] xl:w-[30rem] xl:h-[35rem] 2xl:w-[40rem] 2xl:h-[35rem] 2xl:ml-20"
                  />
            </div>

            <div className="flex flex-wrap w-full md:justify-center lg:w-[30rem] xl:ml-10 xl:w-[35rem]" >
            <div className=" w-[14rem] h-64 m-auto mt-8 rounded-lg border border-black text-center lg:mt-0 xl:w-[16rem]">
                <div >
            ...
            <div className=" w-[14rem] h-64 m-auto mt-8 rounded-lg border border-black text-center xl:w-[16rem]">
                <div >
